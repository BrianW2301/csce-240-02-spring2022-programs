...
public class Extractor {
        ...
        public static void Run() throws IOException {
                File input = new File("myrep-chatbot\\data\\South_Carolina_Legislature_Online_Member_Biography.html");
                ...
                // Write to text file
                BufferedWriter writer = new BufferedWriter(new FileWriter("myrep-chatbot\\data\\rep_info.txt"));
